...
/// Dec 2016
///
/// This program is the scene of help page of
/// the Frogger Game.
/// </summary>
...
namespace KKYCAssignment
{
    ...
    public class HelpScene :GameScene 
    {
        ...
        public HelpScene(Game game, SpriteBatch spriteBatch, GraphicsDeviceManager graphics)
            : base(game)
        {
            // TODO: Construct any child components here
            this.spriteBatch = spriteBatch;
            this.graphics = graphics;
            tex = game.Content.Load<Texture2D>("help");
