...
namespace WebUI.Data.Migrations
{
    ...
    [Migration("20161025214840_addShopingCartFK")]
    partial class addShopingCartFK
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("WebUI.Models.ShoppingCart", b =>
                {
            ...
            modelBuilder.Entity("WebUI.Models.Orders", b =>
                {
                    b.HasOne("WebUI.Models.ShoppingCart", "ShoppingCart")
                        .WithOne("Orders")
                        .HasForeignKey("WebUI.Models.Orders", "orderID")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("WebUI.Models.Products", b =>
                {
                    b.HasOne("WebUI.Models.ShoppingCart")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebUI.Models.ShoppingCart", b =>
                {
                    b.HasOne("WebUI.Models.Customers", "Customers")
                        .WithOne("ShoppingCart")
                        .HasForeignKey("WebUI.Models.ShoppingCart", "CartId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
        }
    }
