...
<form action="KKYCDisplayMember.jsp" method="post">
    ...
    <input type="text" name="fullName" id="fullName" style="width: 200px;" required><br>
    <label>Email</label>
    <input type="email" name="email" id="email" style="width: 300px;" required><br>
    <label>Phone</label>
    <input type="text" name="phone" id="phone" style="width: 100px;" ><br>        
